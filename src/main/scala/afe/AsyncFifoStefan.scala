...
class AsyncFifoStefan(depth: Int, width: Int) extends Module {
    ...
    val fifo_inst = Module (new AsyncFifoStefanCore(depth, width))
...
class AsyncFifoStefanCore (depth: Int, width: Int) extends BlackBox(
    ...
    addResource("/vsrc/AsyncFifoStefanCore.sv")
}